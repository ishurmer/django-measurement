...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'measurement_testdistancemodel', (
            ...
            ('distance', self.gf('measurement.fields.DistanceField')(default_unit='ft', unit_field='distance_units', decimal_places=2, max_digits=10)),
    ...
    models = {
        u'measurement.testdistancemodel': {
            ...
            'distance': ('measurement.fields.DistanceField', [], {'default_unit': "'ft'", 'unit_field': "'distance_units'", 'decimal_places': '2', 'max_digits': '10'}),
